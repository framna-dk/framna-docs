...
## Confidentiality in commits, pull requests, and attachments

- Never mention real repository names, project names, or client names in commit messages, pull request titles, or pull request bodies. This applies to every repository this portal serves, not just this one.
